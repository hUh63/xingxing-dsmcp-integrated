...
fun err(code: String, message: String, argument: String? = null, badValue: Any? = null, vararg extra: Pair<String, Any?>): JSONObject {
    ...
    val diag = error.getJSONObject("diagnostics")
